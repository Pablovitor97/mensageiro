    ...
    return(
      <main className={classes.main}>
        ...
        <Paper className={classes.paper}>
          <Typography component="h1" variant="h5">Enviar a mensagem!</Typography>
          <form className={classes.form} onSubmit={(e) => this.submitNewChat(e)}>
            ...
            <Button fullWidth variant='contained' color='primary' className={classes.submit} type='submit'>Enviar</Button>
          </form>
          {
            this.state.serverError ? 
            <Typography component='h5' variant='h6' className={classes.errorText}>
              Incapaz de localizar o usuário
            </Typography> :
            null
          }
        </Paper>
